...
const CONSTS = [
  ...
  // ITEM 66 (٢): the wait-state deadline the panel now arms. A name this roster does not carry
  // is a ReferenceError inside the mounted panel, so the roster follows the panel.

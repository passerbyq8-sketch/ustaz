...
All 116 gates, run by the canonical `npm run gates` runner from `gates.json`:
...
liveworldkill 0 · livenumbersrc 0 · sahihaynlink 0
```

Every one **PASS**, exit code `0`.

```
TOTAL_GATES        116/116 PASS
RECON              PASS=206 WARN=0 FAIL=0

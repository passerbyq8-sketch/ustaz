...
All 108 gates, run by the canonical `npm run gates` runner from `gates.json`:
...
nameform 0 · rejectdoor 0 · articles 0
```

Every one **PASS**, exit code `0`.

```
TOTAL_GATES        108/108 PASS
RECON              PASS=198 WARN=1 FAIL=0

...
All 103 gates, run by the canonical `npm run gates` runner from `gates.json`:
...
authbridge 0 · libbook 0 · attrwiden 0  attrtruth 0 · regexdup 0
```

Every one **PASS**, exit code `0`.

```
TOTAL_GATES        103/103 PASS
RECON              PASS=193 WARN=1 FAIL=0

...
All 109 gates, run by the canonical `npm run gates` runner from `gates.json`:
...
nameform 0 · rejectdoor 0 · articles 0 · asmaa 0
```

Every one **PASS**, exit code `0`.

```
TOTAL_GATES        109/109 PASS
RECON              PASS=199 WARN=1 FAIL=0

...
All 101 gates, run by the canonical `npm run gates` runner from `gates.json`:
...
authbridge 0 · libbook 0 · attrwiden 0
```

Every one **PASS**, exit code `0`.

```
TOTAL_GATES        101/101 PASS
RECON              PASS=191 WARN=1 FAIL=0

...
All 104 gates, run by the canonical `npm run gates` runner from `gates.json`:
...
lessonssearch 0 · fiqhindex 0 · lessonsbrowse 0
locationbridge 0 · deletetruth 0 · schedulepayload 0 · savebridge 0 · authserver 0
authbridge 0 · libbook 0 · attrwiden 0  attrtruth 0 · regexdup 0 · streamkeep 0
```

Every one **PASS**, exit code `0`.

```
TOTAL_GATES        104/104 PASS
RECON              PASS=194 WARN=1 FAIL=0

...
setDailyWird(writeDailyWird({mushaf:{mode:'pages',surah:0}}));}else if(bits[0]==='surah'&&isFinite(n)&&n>=1&&n<=114){setDailyWird(writeDailyWird({mushaf:{mode:'surah',surah:n}}));}};const[picker,setPicker]=useState(false);const[pickerText,setPickerText]=useState('');// The measured height of the pager, taken off the pager itself rather than assumed from

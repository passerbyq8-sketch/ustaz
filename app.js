...
const missing=PRAYER_KEYS.some(k=>t[k]===null);return/*#__PURE__*/React.createElement(EzWidgetShell,{title:ezT('widget.prayer.title'),openLabel:ezT('widget.prayer.open'),onOpen:nav?nav.onOpenPrayer:null},PRAYER_KEYS.map(k=>/*#__PURE__*/React.createElement("div",{key:k,style:s.ezwidRow},/*#__PURE__*/React.createElement("span",{style:s.ezwidName},ezT('widget.prayer.'+k)),/*#__PURE__*/React.createElement("span",{style:s.ezwidValue},prayerClock(t[k])))),missing?/*#__PURE__*/React.createElement("div",{style:s.ezwidNote},ezT('widget.prayer.none')):null,/*#__PURE__*/React.createElement("div",{style:s.ezwidNote},ezT('widget.prayer.note')));}// THE REGION. It maps the reader's list ONCE, in the reader's own order, so the reading order,

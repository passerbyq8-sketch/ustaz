...
head('14) GATE ROSTER (single source: gates.json)');
{
  ...
  const GATES_EXPECTED = 119;  // 119th: libquote -- a request for a book's text is answered with the book's own words, server-composed (LIB_QUOTE_V1, 2026-09-24); 118th: libmujaz

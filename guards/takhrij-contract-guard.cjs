...
(async () => {
  ...
  console.log('\n--- B4B-61. A SHORT QUOTATION IS BRACKETED ONLY AS A WHOLE MATN ---');
  {
    ...
    // R2 (brain-night 2026-09-24) — THE HAMZA IS ONE LETTER ON THREE SEATS. foldArabic folded ؤ to و
    // and ئ to ي each on its own, so the model's «المسؤول» and the Ṣaḥīḥayn's printed «المسئول» never
    // met, and «ما المسؤول عنها بأعلم من السائل» left as «(ابن حبان · لم يوقف على حكم)» (H03-b,
    // reproduced on the twin of the production index). The atoms below are البخاري 50 and مسلم 9
    // as the index holds them. RED on 1c9dc43 in the four rows that read the fold; the control is
    // green on both trees.
    {
      const B50 = "قَالَ: مَا الإِحْسَانُ؟ قَالَ: «أَنْ تَعْبُدَ اللَّهَ كَأَنَّكَ تَرَاهُ، فَإِنْ لَمْ تَكُنْ تَرَاهُ فَإِنَّهُ يَرَاكَ»، قَالَ: مَتَى السَّاعَةُ؟ قَالَ: \" مَا المَسْئُولُ عَنْهَا بِأَعْلَمَ مِنَ السَّائِلِ، وَسَأُخْبِرُكَ عَنْ أَشْرَاطِهَا: إِذَا وَلَدَتِ الأَمَةُ رَبَّهَا، وَإِذَا تَطَاوَلَ رُعَاةُ الإِبِلِ البُهْمُ فِي البُنْيَانِ، فِي خَمْسٍ لاَ يَعْلَمُهُنَّ إِلَّا اللَّهُ \" ثُمَّ تَلاَ النَّبِيُّ صَلَّى اللهُ عَلَيْهِ وَسَلَّمَ: {إِنَّ اللَّهَ عِنْدَهُ عِلْمُ السَّاعَةِ} [لقمان: 34] الآيَةَ، ثُمَّ أَدْبَرَ فَقَالَ: «رُدُّوهُ» فَلَمْ يَرَوْا شَيْئًا، فَقَالَ: «هَذَا جِبْرِيلُ جَاءَ يُعَلِّمُ النَّاسَ دِينَهُمْ» قَالَ أَبُو عَبْدِ اللَّهِ: جَعَلَ ذَلِكَ كُلَّهُ مِنَ الإِيمَانِ\n51 - حَدَّثَنَا إِبْرَاهِيمُ بْنُ حَمْزَةَ، قَالَ: حَدَّثَنَا إِبْرَاهِيمُ بْنُ سَعْدٍ، عَنْ صَالِحٍ، عَنِ ابْنِ شِهَابٍ، عَنْ عُبَيْدِ اللَّهِ بْنِ عَبْدِ اللَّهِ، أَنَّ عَبْدَ اللَّهِ بْنَ عَبَّاسٍ، أَخْبَرَهُ قَالَ: أَخْبَرَنِي أَبُو سُفْيَانَ بْنُ حَرْبٍ، \" أَنَّ هِرَقْلَ، قَالَ لَهُ: سَأَلْتُكَ هَلْ يَزِيدُونَ أَمْ يَنْقُصُونَ؟ فَزَعَمْتَ أَنَّهُمْ يَزِيدُونَ، وَكَذَلِكَ الإِيمَانُ حَتَّى يَتِمَّ، وَسَأَلْتُكَ هَلْ يَرْتَدُّ أَحَدٌ سَخْطَةً لِدِينِهِ بَعْدَ أَنْ يَدْخُلَ فِيهِ؟ فَزَعَمْتَ أَنْ لاَ،";
      const M9 = "قَالَ: «أَنْ تَعْبُدَ اللهَ كَأَنَّكَ تَرَاهُ، فَإِنَّكَ إِنْ لَا تَرَاهُ فَإِنَّهُ يَرَاكَ»، قَالَ: يَا رَسُولَ اللهَ، مَتَى السَّاعَةُ؟ قَالَ: \" مَا الْمَسْئُولُ عَنْهَا بِأَعْلَمَ مِنَ السَّائِلِ، وَلَكِنْ سَأُحَدِّثُكَ عَنْ أَشْرَاطِهَا: إِذَا وَلَدَتِ الْأَمَةُ رَبَّهَا، فَذَاكَ مِنْ أَشْرَاطِهَا، وَإِذَا كَانَتِ الْعُرَاةُ الْحُفَاةُ رُءُوسَ النَّاسِ، فَذَاكَ مِنْ أَشْرَاطِهَا، وَإِذَا تَطَاوَلَ رِعَاءُ الْبَهْمِ فِي الْبُنْيَانِ، فَذَاكَ مِنْ أَشْرَاطِهَا فِي خَمْسٍ لَا يَعْلَمُهُنَّ إِلَّا اللهُ، ثُمَّ تَلَا صَلَّى اللهُ عَلَيْهِ وَسَلَّمَ: {إِنَّ اللهِ عِنْدَهُ عِلْمُ السَّاعَةِ وَيُنَزِّلُ الْغَيْثَ وَيَعْلَمُ مَا فِي الْأَرْحَامِ وَمَا تَدْرِي نَفْسٌ مَاذَا تَكْسِبُ غَدًا وَمَا تَدْرِي نَفْسٌ بِأَيِّ أَرْضٍ تَمُوتُ إِنَّ اللهَ عَلِيمٌ خَبِيرٌ} [لقمان: 34] \" قَالَ: ثُمَّ أَدْبَرَ الرَّجُلُ، فَقَالَ رَسُولُ اللهِ صَلَّى اللهُ عَلَيْهِ وَسَلَّمَ: «رُدُّوا عَلَيَّ الرَّجُلَ»، فَأَخَذُوا لِيَرُدُّوهُ، فَلَمْ يَرَوْا شَيْئًا، فَقَالَ رَسُولُ اللهِ صَلَّى اللهُ عَلَيْهِ وَسَلَّمَ: «هَذَا جِبْرِيلُ جَاءَ لِيُعَلِّمَ النَّاسَ دِينَهُمْ»";
      const MASUL = 'ما المسؤول عنها بأعلم من السائل';
      ok('R2 · ء, ؤ and ئ fold to one hamza, in the comparison only',
        T61.foldArabic('المسؤول') === T61.foldArabic('المسئول') && T61.foldArabic('رؤوس') === T61.foldArabic('رءوس') && T61.foldArabic('شؤون') === T61.foldArabic('شئون'));
      ok('R2 · control · a hamza that is missing, not re-seated, is still another word',
        T61.foldArabic('المسؤول') !== T61.foldArabic('المسول') && T61.foldArabic('بئر') !== T61.foldArabic('بر') && T61.foldArabic('على') === T61.foldArabic('علي'));
      ok('R2 · «ما المسؤول عنها بأعلم من السائل» is carried by البخاري 50, which prints «المسئول»',
        T61.atomCarriesMatn(T61.narrationOf(B50), MASUL));
      const R2T = 'قال النبي صلى الله عليه وسلم لجبريل: «' + MASUL + '» وهذا في حديث جبريل.';

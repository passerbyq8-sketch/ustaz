...
(async function main() {
  ...
  // ── ١١٣ · THE CLASS, NOT THE LIST (second order, step 4) ─────────────────────
  // Every phrasing measured on 21 September 2026 fires — the thirteen the old list missed among
  // them — and none of the negatives does: «حكم» asked of a ruling, «ثابت» as a man, «صحّ» of a
  // fast or a sale, «الحديث» as talk or as a category. The same lists live in
  // ustaz-archive/probes/ez111-harness/second-order/phrasings4.mjs.
  for (const q of [
    'حديث «المسلم من سلم المسلمون من لسانه ويده» من أخرجه وما درجته؟',
    'ما درجة حديث «من غشنا فليس منا» ومن خرجه؟',
    'هل حديث «حب الوطن من الإيمان» ثابت؟',
    'ما صحة حديث «اطلبوا العلم ولو بالصين»؟',
    'ما درجة حديث «أحبوا العرب لثلاث»؟',
    'اذكر لي ستة أحاديث في فضل الصيام مع تخريج كل حديث.',
    'هل ثبت حديث «حب الوطن من الإيمان»؟',
    'هل حديث «حب الوطن من الإيمان» ثابت؟',
    'هل حديث «حب الوطن من الإيمان» صحيح؟',
    'هل يصح حديث «حب الوطن من الإيمان»؟',
    'هل صح حديث «حب الوطن من الإيمان»؟',
    'ما صحة حديث «حب الوطن من الإيمان»؟',
    'ما مدى صحة حديث «حب الوطن من الإيمان»؟',
    'ما درجة حديث «حب الوطن من الإيمان»؟',
    'ما حكم حديث «حب الوطن من الإيمان»؟',
    'قرأت «حب الوطن من الإيمان» هل هذا الحديث صحيح؟',
    'حديث «حب الوطن من الإيمان» هل له أصل؟',
    'حديث «حب الوطن من الإيمان» هل هو موضوع؟',
    'حديث «حب الوطن من الإيمان» هل هو ضعيف؟',
    'هل ورد حديث «حب الوطن من الإيمان»؟',
    'هل قال النبي ﷺ «حب الوطن من الإيمان»؟',
    'هل «حب الوطن من الإيمان» حديث؟',
    'من روى حديث «حب الوطن من الإيمان»؟',
    'حديث «حب الوطن من الإيمان» من أخرجه؟',
    'خرج لي حديث «حب الوطن من الإيمان».',
    'ما تخريج حديث «حب الوطن من الإيمان»؟',
    'حديث «حب الوطن من الإيمان» صحيح أم ضعيف؟',
    'هل يثبت حديث «حب الوطن من الإيمان»؟',
    'هل ثابت عن النبي ﷺ أنه قال «حب الوطن من الإيمان»؟',
    'ما درجة حديث «من صام رمضان إيمانًا واحتسابًا»؟',
    'هل يصح حديث الأعمال بالنيات؟',
    'ما صحة حديث نضر الله امرأً سمع مقالتي؟',
    'من خرّج هذا الحديث؟',
    'ما حكم الحديث سندًا؟',
    'هل صح عن النبي صلى الله عليه وسلم أنه نهى عن الشرب قائما؟',
    'قال رسول الله ﷺ «الدين النصيحة» ما درجته؟',
    'هل هذا الحديث مرفوع أم موقوف؟',
    'هل قاله النبي ﷺ أم هو من كلام السلف: «حب الوطن من الإيمان»؟',
    'اذكر ثلاثة أحاديث مع تخريج كل حديث.',
    'اذكر ستة أحاديث مع تخريج كل حديث.',
  ]) {
    ok('D6: a grading question by its class — «' + q.slice(0, 34) + '…»', TD.asksForGrading(q) === true);
  }
  for (const q of [
    'ما حكم النميمة؟',
    'ما حكم صيام السبت؟',
    ...
    'ما حكم الحديث أثناء خطبة الجمعة؟',
    'ما حكم الحديث مع المخطوبة بالهاتف؟',
    'ما حكم قراءة القرآن للحائض مع أن النبي ﷺ كان يقرأ على كل أحيانه؟',
    'ما حكم الاحتفال بالمولد النبوي؟',
    'هل روى ثابت البناني عن أنس؟',
    'من هو ثابت بن قيس بن شماس؟',
    'هل ثبت سماع الحسن البصري من علي بن أبي طالب؟',
    'كم عدد الأحاديث التي رواها أبو هريرة؟',
    'ما صحة نسبة كتاب الرسالة إلى الشافعي؟',
    'هل صح صيامي إذا نسيت النية؟',
    'هل يصح الوضوء بماء البحر؟',
    'هل صلاتي صحيحة إذا صليت جالسا؟',
    'هل يصح بيع الذهب بالتقسيط مع حديث «الذهب بالذهب»؟',
    'هل ثبت هلال رمضان في السعودية؟',
    'هل صح زواجي بدون ولي والنبي ﷺ قال «لا نكاح إلا بولي»؟',
    'ما درجة الحرارة في مكة اليوم؟',
    'اشرح حديث إنما الأعمال بالنيات',
    'ما معنى حديث الحياء من الإيمان؟',
    'كم عدد ركعات صلاة الفجر؟',
    'ما موضوع الدرس اليوم؟',
    'اشتريت جهاز حديث، ما حكم بيعه؟',
    'ما موضوع حديث الشيخ في الدرس اليوم؟',
  ]) {
    ok('D6: NOT a grading question — «' + q.slice(0, 34) + '…»', TD.asksForGrading(q) === false);
  }

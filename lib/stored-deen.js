...
// م٢-ط (BEFORE_WRITING_V1) — THE ENCYCLOPEDIA'S YIELDING WARM-UP, CARRIED ACROSS FOR api/ask.js. That file
// may not import lib/encyclopedia.js itself (gate cardorcontext B1/B2 seals its absence), and it already
// imports this module; so the warm-up crosses here, by name, and nothing else of that module does.
export { warmEncyclopedia as warmStoredCorpusIndex } from './encyclopedia.js';

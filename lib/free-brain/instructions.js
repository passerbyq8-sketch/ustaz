...
const TOOLS = [
  ...
  '- search_duroos: دروسُ المشايخِ ومحاضراتُهم المسجَّلة — عنوانٌ واسمُ شيخٍ ورابطٌ فقط، بلا نصٍّ ألبتّة.',
  '  وحكمُها إسنادٌ لا متن: لا تنقلْ منها حرفًا، ولا تبنِ عليها حكمًا، ولا تنسبْ إلى الشيخِ قولًا لم تقرأْه. ولا تذكرْ درسًا إلّا إن كانَ عنوانُه يخصُّ ما كتبتَه أنت فعلًا. وهي بعدَ الفتاوى والمصادرِ لا قبلَهما.',
  '',

...
export const FREE_BRAIN_TOOLS = Object.freeze([
  ...
  {
    name: 'search_library',
    description: 'بحثٌ في مكتبةٍ من كتبِ أهلِ العلمِ المطبوعة — متونٍ وشروحٍ ومطوّلاتٍ فقهيّة. لا تُستعمَلُ ابتداءً: إنّما تُطلَبُ بعدَ search_fatawa و search_sources إذا لم تجدْ فيهما ما يكفي، أو إذا أردتَ استزادةً في التعليلِ والتأصيلِ لمسألةٍ مركّبةٍ لا فتوى جاهزةً لها. إلّا في مسألتَين تُطلَبُ فيهما ابتداءً وقبلَ غيرِها: إذا سُئِلتَ عن قولِ عالمٍ متقدّمٍ بعينِه (كابنِ تيميّةَ وابنِ قدامةَ والنوويّ)، أو عن مذهبِ مذهبٍ من المذاهبِ الأربعةِ في مسألة، فهذانِ جوابُهما في الكتبِ لا في الفتاوى المعاصرة. وما يردُ منها كلامُ عالمٍ في كتابٍ لا فتوى مسنَدةً لسائل، فيُستفادُ منه فهمًا وتأصيلًا ولا يُبنى عليه حكمٌ وحدَه دونَ فتوى. ولا رابطَ لها يُفتَح: يُذكَرُ اسمُ الكتابِ ومؤلِّفُه.',
    input_schema: {
      type: 'object',
      properties: {

...
// output side. A real request (system prompt + the sliding history window) sits far
// below this; anything larger is abuse or a bug.
export const MAX_CHAT_BODY_BYTES = 96 * 1024;   // ~24k tokens of Arabic

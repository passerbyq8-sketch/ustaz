...
export const MAX_CHAT_BODY_BYTES = 2 * 1024 * 1024; // raised 256KB->2MB: one downscaled image (~600KB base64) + the ~111KB prompt + history exceeded 256KB and 413'd every turn. Vercel's platform limit is 4.5MB. The real money ceiling is the Anthropic Console monthly cap. TIGHTEN BEFORE PUBLIC LAUNCH.

...
export const FATWA_EXPECTED_SCHOLARS = 19;
export const FATWA_EXPECTED_TOTAL = 80435;
export const FATWA_EXPECTED_IBN_BAZ_TOTAL = 24145;
...
// Measured from GET /api/v1/scholars on 2026-09-09. Counts are deliberately
...
export const FATWA_SCHOLARS = Object.freeze([
  row('binbaz', 'ibn-baz', 'ابن باز', 24145, 'binbaz.org.sa', ['ابن باز', 'بن باز', 'عبدالعزيز بن باز', 'عبد العزيز بن باز']),
  ...
  row('kuwait_eftaa', 'eftaa-committee-kw', 'الإفتاء الكويتية', 252, 'eftaa.awqaf.gov.kw', ['إدارة الإفتاء الكويتية', 'الافتاء الكويتية', 'الإفتاء الكويتية']),
  ...
  row('ferkous', 'ferkous', 'محمد علي فركوس', 1412, 'ferkous.app', ['فركوس', 'محمد علي فركوس', 'الشيخ فركوس', 'أبو عبد المعز', 'أبي عبد المعز']),

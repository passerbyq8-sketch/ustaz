...
//
// EXPORTED 2026-09-19, and for one reason: lib/today-line.js needs the Kuwait CLOCK as well as
// the Kuwait DATE, and the only alternative was a second `3 * 60 * 60 * 1000` in a second file.
// Two copies of an offset is how a day boundary and a clock come to disagree about what day it
// is. There is one definition of Kuwait time in this repository and this is it.

...
//
// AND islamqa.info WAS THE DANGEROUS ONE. It does print «الإجابة» — in the FEEDBACK WIDGET under
// the answer («هل أعجبتك الإجابة؟ نعم / لا»). So byLabels found that label, took everything after
...
export const EXTRACTORS = Object.freeze({
  ...
  // cause — the only «الإجابة» on the page is the feedback widget UNDER the answer, so the reader
  // began the answer after the answer had ended.
  //

...
// This is intentionally a small allow-list. Matching the person's name without matching the
// source is the incident this reviewer exists to prevent. An authority not listed here therefore
// loses the attribution until its official source rule is added deliberately.
const AUTHORITY_SOURCES = Object.freeze([
  Object.freeze({
    canonical: 'ابن باز',
    aliases: Object.freeze(['ابن باز', 'عبد العزيز بن باز', 'عبدالعزيز بن باز', 'عبد العزيز بن عبد الله بن باز']),
    hosts: Object.freeze(['binbaz.org.sa']),
    ids: Object.freeze(['binbaz:']),
  }),
  Object.freeze({
    canonical: 'ابن عثيمين',
    aliases: Object.freeze(['ابن عثيمين', 'محمد بن صالح العثيمين', 'محمد بن صالح بن عثيمين']),
    hosts: Object.freeze(['binothaimeen.net', 'ibnothaimeen.com']),
    ids: Object.freeze(['binothaimeen:', 'ibnothaimeen:']),
  }),
  Object.freeze({
    canonical: 'الإسلام سؤال وجواب',
    aliases: Object.freeze(['الإسلام سؤال وجواب', 'موقع الإسلام سؤال وجواب']),
    hosts: Object.freeze(['islamqa.info']),
    ids: Object.freeze(['islamqa:']),
  }),
  Object.freeze({
    canonical: 'دار الإفتاء المصرية',
    aliases: Object.freeze(['دار الإفتاء المصرية']),
    hosts: Object.freeze(['dar-alifta.org']),
    ids: Object.freeze(['dar-alifta:']),
  }),
  Object.freeze({
    canonical: 'وزارة الأوقاف الكويتية',
    aliases: Object.freeze(['وزارة الأوقاف الكويتية', 'وزارة الأوقاف والشؤون الإسلامية الكويتية']),
    hosts: Object.freeze(['awqaf.gov.kw']),
    ids: Object.freeze(['awqaf-kuwait:']),
  }),
]);

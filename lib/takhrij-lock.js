...
const FORBIDDEN_ASCRIPTION_RE = /(?:^| )(?:[وف]?(?:لا|ليس|الا)|لكن لا|فلا|ولا|ان لا) (?:(?:يجوز|يصح|ينبغي|يحل|يسوغ|يجوز لاحد)(?: \S+){0,3} (?:ان )?)?(?:ينسب|تنسب|ينسبه|نسبته|نسبتها|نسبه|نسبه|يعزي|يعزا|يروي|يحدث|يقال|يذكر)(?: \S+){0,14} (?:علي |ب)?(?:انه|انها|كونه|كونها)(?: \S+){0,2}$/u;

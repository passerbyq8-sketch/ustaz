...
// Deps: jsdom, @mozilla/readability
...
// Public API. Brave-search the query, fetch+clean ALL hits in parallel (each with
// its own timeout), drop blocked/failed/thin results, and format one tool_result
// string. Degrades to NO_SOURCE_TEXT (never fabricates) when nothing is usable.
export async function retrieve(
  ...
  // Parallel fetch — sequential would blow the time budget. Each fetch owns its timeout.

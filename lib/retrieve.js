...
import { filterSitesForPurpose, isVideoAnswerDomain } from './source-registry.js';
...
async function searchWeb(q, num = 3, label = '', timeoutMs = 8000) {
...
async function runSearchPass(
  ...
  {
    maxResults = 5, perFetchTimeoutMs = 8000, searchTimeoutMs = 8000,

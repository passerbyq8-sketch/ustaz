...
const ROWS = [
  ...
  R({
    domain: 'ferkous.com', ownerId: 'ferkous', adapterId: 'readability', adapterVersion: 'r1',
    health: 'enabled', caps: { fatwa: 70, tafsir: 30, hadith_text: 25, general_article: 40 },
  }),
  R({
  ...
  R({
    ...
    health: 'enabled',
    caps: { hadith_explanation: 60, hadith_text: 45, tafsir: 45, general_article: 50, fatwa: 30 },
  }),
  R({
    domain: 'othmanalkhamees.com', ownerId: 'othman-alkhamees', adapterId: 'readability', adapterVersion: 'r1',
    health: 'enabled',
    caps: { hadith_explanation: 45, hadith_text: 40, tafsir: 35, general_article: 50, fatwa: 30 },
  }),
  ...
  R({
    ...
    health: 'enabled',
    caps: { hadith_grading: 95, hadith_text: 92, hadith_explanation: 70, fatwa: 35, general_article: 30 },
    note: 'حديث وتخريج وموسوعة فقهية حسب الصفحة؛ ليس مصدر تفسير ولا رأي شخصي.',
  }),
  R({
    domain: 'tafsir.app', ownerId: null, adapterId: 'readability', adapterVersion: 'r1',
    health: 'enabled', caps: { tafsir: 90, general_article: 35 },
    note: 'مجمّع كتب التفسير الكلاسيكية؛ ليس مصدر فتوى ولا تخريج.',
  }),
  R({
  ...
  R({
    ...
    health: 'enabled', caps: { general_article: 50 },
    note: 'تاريخ وسِيَر؛ ليس مصدر حكم.',
  }),
  R({

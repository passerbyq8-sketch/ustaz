...
//
//   unset     the shipped model, unchanged: credential + store value. In production,
//             with the store value never written, this is OFF — which is why it stays the default.
...
export async function decidePath(req, now = Date.now()) {
  ...
  // NO MODE SET: the shipped rollout model. Credential, then the

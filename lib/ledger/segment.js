...
// ANSWER UNITS split on the structural break a page makes between two answers: a blank line,
// or one of the labels these sites use to start a new question. Deliberately conservative —
// over-splitting costs a claim the chance to span two sentences of ONE answer, which is a
// cost; under-splitting costs the invariant, which is a defect.
...
// Counted, never acted on. These are the shapes a page uses when it is talking to the model
...
export function segmentPage(page) {
  ...
  return Object.freeze({
    ...
    injectionMarkers: Object.freeze(injectionMarkersIn(text)),

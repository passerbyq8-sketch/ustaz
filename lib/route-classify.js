...
const FORMULAS = [
  'صلي الله عليه وسلم', 'صلي الله عليه وعلي اله وسلم', 'رضي الله عنهم', 'رضي الله عنه',
  'الله يجزاك خير', 'جزاك الله خيرا', 'جزاك الله خير', 'الله يعطيك العافيه',
  'الله يبارك فيك', 'بارك الله فيك', 'الله يعافيك', 'الله يسلمك', 'الله يوفقك',
  'الله يرحمه', 'يعطيك العافيه', 'ما شاء الله', 'ان شاء الله', 'الحمد لله',
  'سبحان الله', 'بسم الله', 'عليه السلام', 'صباح الخير', 'مساء الخير',
  'السلام عليكم ورحمه الله وبركاته', 'السلام عليكم ورحمه الله', 'السلام عليكم',
  'وعليكم السلام', 'حياك الله', 'يا الله', 'يالله', 'والله', 'تسلم', 'مشكور', 'شكرا',
];

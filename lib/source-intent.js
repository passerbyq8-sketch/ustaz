...
// Kept row for row with the dr-mutlaq.com alias list in lib/source-registry.js: a reader the
// registry can resolve is a reader the intent layer can route (M1+M2 night 3, task 3 — night
// 2's incidental 5 was six spellings here against seven there). Bare «مطلق» is on neither
// list: it is reserved to the owner.
const MUTLAQ_NAME = N([
  'مطلق الجاسر', 'د مطلق', 'الشيخ مطلق', 'دكتور مطلق', 'مطلق جاسر', 'الجاسر',
  'الشيخ الجاسر', 'الدكتور مطلق',
]);

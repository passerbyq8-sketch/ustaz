...
const BY_FRAMES = [
  /(?:ما|وما|ايش)\s*(?:هو|هي)?\s*(?:راي|قول|مذهب|اختيار|ترجيح|فتوي|كلام|تفصيل)\s*(?:شيخ الاسلام|الشيخ|الامام|العلامه|شيخ|الدكتور)?\s*$/u,
  /(?:قال|يقول|ذكر|افتي|رجح|اختار|نص|يري|يجيز|يمنع|ضعف|صحح|حسن)\s*(?:شيخ الاسلام|الشيخ|الامام|العلامه|شيخ|الدكتور)?\s*$/u,
